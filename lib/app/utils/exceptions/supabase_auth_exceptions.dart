...
class MySupabaseAuthException implements Exception {
  /// The error code associated with the exception.
  final String code;

  /// Constructor that takes an error code.
  MySupabaseAuthException(this.code);
  ...
  String get message {
    switch (code) {
      ...
      case 'session-cookie-expired':
        return 'The Supabase session cookie has expired. Please sign in again.';
      case 'uid-already-exists':
        return 'The provided user ID is already in use by another user.';
      case 'invalid-cordova-configuration':
        return 'The provided Cordova configuration is invalid.';
      case 'app-deleted':
        return 'This instance of SupabaseApp has been deleted.';
      case 'user-disabled':
      ...
      case 'app-not-authorized':
        return 'The app is not authorized to use Supabase Authentication with the provided API key.';
      case 'keychain-error':
